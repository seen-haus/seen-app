...
export default {
  ...
  setup() {
    ...
    const faq = [
      ...
      {question: "Is an NFT equivalent to a title?", answer: "In the current legal environment, title deeds cannot be directly represented by a token, but legal entities can. The home is owned by a Florida Limited Liability Company (LLC). The LLC is “tokenized into” a specific NFT and made available for purchase."},
      ...
      {question: "Where is the LLC registered?", answer: "Florida, United States."},
