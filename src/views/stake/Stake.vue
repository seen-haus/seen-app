<template>
  <div class="bg-light-grey">
    <container class="flex flex-col gap-24 py-12">
      ...
      <div class="grid grid-cols-1 gap-12 justify-between my-12">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 justify-between gap-4">
          <span class="bg-white rounded-lg shadow-lifted p-8 text-center items-center flex flex-col gap-4 col-span-3">
            <span class="text-white bg-black font-black p-6 rounded-lg text-3xl">1</span>
            <span class="font-medium text-gray-400">Deposit your SEEN</span>
          </span>
          <span class="bg-white rounded-lg shadow-lifted p-8 text-center items-center flex flex-col gap-4 col-span-3">
            <span class="text-white bg-black font-black p-6 rounded-lg text-3xl">2</span>
            <span class="font-medium text-gray-400">Receive xSEEN in return</span>
          </span>
          <span class="bg-white rounded-lg shadow-lifted p-8 text-center items-center flex flex-col gap-4 col-span-3">
            <span class="text-white bg-black font-black p-6 rounded-lg text-3xl">3</span>
            <span class="font-medium text-gray-400">Start earning a portion of protocol fees</span>
          </span>
          <span class="bg-white rounded-lg shadow-lifted p-8 text-center items-center flex flex-col gap-4 col-span-3">
            <span class="text-white bg-black font-black p-6 rounded-lg text-3xl">4</span>
